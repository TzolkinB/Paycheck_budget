...
class IncomesControllerTest < ActionController::TestCase
  ...
  test "should create income" do
    assert_difference('Income.count') do
      post :create, income: { act_income: @income.act_income, pro_income: @income.pro_income, title: @income.title }
    end
  ...
  test "should update income" do
    patch :update, id: @income, income: { act_income: @income.act_income, pro_income: @income.pro_income, title: @income.title }
    assert_redirected_to income_path(assigns(:income))
  end
